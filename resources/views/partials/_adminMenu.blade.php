					...
					@if (Auth::user()->email == env('ADMIN_AUTH_MAIL'))
                        <li class="dropdown">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-pencil fa-lg"> Администрирование</i> <span class="caret"></span></a>
